...
# Se crea la tabla
columns = [
    "excedente_por_liquidar_deudor varchar(120) NOT NULL",
    "excedente_por_liquidar_numero_dcto integer primary key NOT NULL unique",
    "excedente_por_liquidar_valor_dcto bigint NOT NULL",
    "excedente_por_liquidar_valor_cancelado bigint NOT NULL",
    "excedente_por_liquidar_fecha_vencimiento timestamp NOT NULL",
    "excedente_por_liquidar_fecha_pago timestamp NOT NULL",
    "excedente_por_liquidar_excedente bigint NOT NULL",
    "excedente_por_liquidar_diferencia_precio bigint NOT NULL",
    "excedente_por_liquidar_gasto bigint NOT NULL",
    "excedente_por_liquidar_devolucion_cliente bigint NOT NULL"
]

create_table.create_table(cursor, "excedente_por_liquidars", columns)
...
for i in range(ROWS):
    ...
    excedente_por_liquidar = {
        "excedente_por_liquidar_deudor": empresas_lista[i][2],
        "excedente_por_liquidar_numero_dcto": i,
        "excedente_por_liquidar_valor_dcto": valor_dcto,
        "excedente_por_liquidar_valor_cancelado": valor_dcto,
        "excedente_por_liquidar_fecha_vencimiento": fecha_vencimiento,
        "excedente_por_liquidar_fecha_pago": fecha_pago,
        "excedente_por_liquidar_excedente": excedente,
        "excedente_por_liquidar_diferencia_precio": dif_precio,
        "excedente_por_liquidar_gasto": 0,
        "excedente_por_liquidar_devolucion_cliente": dev_cliente,
    }
    #excedente_list.append(excedente_por_liquidar)
    insert_into.insert_into(cursor, "excedente_por_liquidars", excedente_por_liquidar)
    print(f"Registro {i} creado")

cursor.close()
conn.close()
"""
with open("excedente_por_liquidar.csv", mode="w", newline="", encoding="utf-8") as file:
