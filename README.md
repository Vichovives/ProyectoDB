...
* Cada cliente tiene un registro de operaciones, identificado por el ID del cliente y tiene como atributos número de factura, gasto operacional, monto, mora y fecha.
